...
# MAGIC To run this demo, just select the cluster `dbdemos-mlops-end2end-amitoz_sidhu` from the dropdown menu ([open cluster configuration](https://cse2.cloud.databricks.com/#setting/clusters/0401-121959-8h3zq5xf/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=8194341531897276&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F00_mlops_end2end_presentation&uid=4789931231172450">
...
# MAGIC 
# MAGIC Ultimately, we will be able to build a [complete DBSQL Churn Dashboard](/sql/dashboards/29ee1c00-47a4-4c3c-ba05-cfae207dc84a-churn-prediction-dashboard---universal?o=1444828305810485#) containing all our customer & churn information!
